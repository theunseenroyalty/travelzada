        ...
        <ul class="nav nav-pills nav-stacked custom-nav">
            ...
            <li class="menu-list">
                <a href="#"><i class="fa fa-cogs"></i>
                    <span>Home <i class="lnr lnr-chevron-right"></i></span></a>
            ...
            <li class="menu-list">
                <a href="#"><i class="fa fa-cogs"></i>
                    <span>About Us <i class="lnr lnr-chevron-right"></i></span></a>
                <ul class="sub-menu-list">
                    <li><a href="carousels.html">Carousels</a> </li>
                    <li><a href="cards.html">Default cards</a> </li>
                    <li><a href="people.html">People cards</a></li>
            ...
            <li class="menu-list">
                <a href="#"><i class="fa fa-cogs"></i>
                    <span>Services <i class="lnr lnr-chevron-right"></i></span></a>
                <ul class="sub-menu-list">
                    <li><a href="carousels.html">Carousels</a> </li>
                    <li><a href="cards.html">Default cards</a> </li>
                    <li><a href="people.html">People cards</a></li>
            ...
            <li class="menu-list">
                <a href="#"><i class="fa fa-cogs"></i>
                    <span>Packages <i class="lnr lnr-chevron-right"></i></span></a>
                <ul class="sub-menu-list">
                    <li><a href="carousels.html">Carousels</a> </li>
                    <li><a href="cards.html">Default cards</a> </li>
                    <li><a href="people.html">People cards</a></li>
            ...
            <li class="menu-list">
                <a href="#"><i class="fa fa-cogs"></i>
                    <span>Contact <i class="lnr lnr-chevron-right"></i></span></a>
                <ul class="sub-menu-list">
                    <li><a href="carousels.html">Carousels</a> </li>
                    <li><a href="cards.html">Default cards</a> </li>
                    <li><a href="people.html">People cards</a></li>
            ...
            <li class="menu-list">
                <a href="#"><i class="fa fa-cogs"></i>
                    <span>Book Now <i class="lnr lnr-chevron-right"></i></span></a>
                <ul class="sub-menu-list">
                    <li><a href="carousels.html">Carousels</a> </li>
                    <li><a href="cards.html">Default cards</a> </li>
                    <li><a href="people.html">People cards</a></li>
